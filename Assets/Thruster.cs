...
public class Thruster : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (turningMode) {
            ...
            if (Input.GetKey(KeyCode.W)) forwardPitch(vel / 10);
            if (Input.GetKey(KeyCode.S)) backPitch(vel / 10);
            if (Input.GetKey(KeyCode.A)) leftRoll(vel / 10);
            if (Input.GetKey(KeyCode.D)) rightRoll(vel / 10);
            ...
            if (Input.GetKey(KeyCode.Space)) thrustAll(vel);
            if (Input.GetKey(KeyCode.W)) forwardThrust(vel / 2);
            if (Input.GetKey(KeyCode.S)) backThrust(vel / 2);
            if (Input.GetKey(KeyCode.A)) leftYaw(vel / 10);
            if (Input.GetKey(KeyCode.D)) rightYaw(vel / 10);
        }
